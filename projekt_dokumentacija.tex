...
\subsubsection{PersistentMapping, PersistentList i BTrees}

Za spravljanje kolekcija u ZODB-u koristi se \texttt{PersistentMapping} i 
\texttt{PersistentList} umjesto običnih Python rječnika i listi. Za veće 
kolekcije podataka koje zahtijevaju efikasno pretraživanje i sortiranje, 
ZODB koristi \texttt{BTrees} (npr. \texttt{OOBTree}).

\begin{lstlisting}[caption={OOBTree u ZODB-u},label={lst:btree}]
from BTrees.OOBTree import OOBTree

root['high_scores'] = OOBTree()
# Podaci su automatski sortirani po kljucu
\end{lstlisting}
